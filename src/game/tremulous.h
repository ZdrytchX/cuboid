...
#define HELMET_MK1_PRICE                90
#define HELMET_MK1_POISON_PROTECTION    0
#define HELMET_MK1_PCLOUD_PROTECTION    500
#define HELMET_MK2_PRICE                HELMET_MK1_PRICE
#define HELMET_MK2_POISON_PROTECTION    1
#define HELMET_MK2_PCLOUD_PROTECTION    1000
...
#define MEDKIT_POISON_IMMUNITY_TIME 15000
#define MEDKIT_STARTUP_TIME         4000
#define MEDKIT_STARTUP_SPEED        5

#define BIORES_PRICE                300
#define BIORES_EQUATION             (1-hp)*sqrt(hp)*5+0.2 //health regenerated per second, note: hp is a floating-point value 0 <= hp <= 1
#define BIORES_POISON_MODIFIER      0.3f
...
#define ALIEN_IMPREGNATION_CHANCE_NAKED       0.60f
#define ALIEN_IMPREGNATION_CHANCE_ARMORED     0.15f
#define ALIEN_IMPREGNATION_REWARD             ALIEN_CREDITS_PER_KILL //reward for the granger than impregnated (awarded when someone kills the human by spawning)
#define ALIEN_IMPREGNATION_REWARD_SCORE       1500 //15 points

#define ALIEN_IMPLANT_MATURING_TIME_MIN       8000   //time before maturing can occur
