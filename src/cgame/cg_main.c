...
//ZdrytchX
//thirdpersonheight default is '0' for GPP
...
static void CG_RegisterSounds( void )
{
  ...
  cgs.media.alienHatchSound         = trap_S_RegisterSound( "sound/player/alienhatch.wav", qfalse );
  cgs.media.alienFailedHatchSound   = trap_S_RegisterSound( "sound/player/alienfailedhatch.wav", qfalse );
...
static void CG_RegisterGraphics( void )
{
  ...
  cgs.media.alienHatchPS              = CG_RegisterParticleSystem( "alienHatchPS" );
